...
public class ApiCalls {
    ...
    public static String registerUser(String username, String password) {
        try {
            final Content content = Request.Post("http://localhost:8090/demo/register")
    ...
    public static String registerBook(String title) {
        try {
            final Content content = Request.Post("http://localhost:8090/demo/registerbook")
    ...
    public static String registerBorrowers(String name) {
        try {
            final Content content = Request.Post("http://localhost:8090/demo/registerborrower")
